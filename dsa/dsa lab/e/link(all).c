...
struct dlnode *insert(struct dlnode *head)
{
...
struct node *delete(struct node *head)
{
    ...
    int pos,i;
    printf("ente the position of node to delete :");
    scanf("%d",&pos);
    if (pos==1)
    {
        curr=head;
...
void main()
{
  ...
  int ch;
   printf("\n_______________________SINGLY LINKEDLIST____________________");
  while(1)
